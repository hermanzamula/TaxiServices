...
public class DemoDataCreator {
    ...
    public static final String BONUS_DESCRIPTION = "ИДС Bonus существует с 2004 года - это надежная служба заказа такси по разумным ценам.\n" +
            "Круглосуточный вызов такси в любую точку Киева и ближний загород, встречи на ЖД-вокзалах, в аэропортах.\n" +
            "Предоставляем большой спектр услуг ( курьерская услуга, драйвер и множество других услуг). \n" +
            "Автопарк компании на 100 % укомплектован комфортными иномарками не ниже среднего класса.";
